$Url = 'https://api.github.com/repos/MarksonHon/homebrew-v2raya/releases/latest'
...
If ($Version_Current -eq $Version_Latest) {
    ...
    $New_SHA256_Darwin_A64 = curl -sL "https://github.com/MarksonHon/homebrew-v2raya/releases/download/1.5.7-9/v2raya-aarch64-macos-sha256.txt"
    $New_SHA256_Darwin_x64 = curl -sL "https://github.com/MarksonHon/homebrew-v2raya/releases/download/1.5.7-9/v2raya-x86_64-macos-sha256.txt"
    $New_SHA256_Linux_x64 = curl -sl "https://github.com/MarksonHon/homebrew-v2raya/releases/download/1.5.7-9/v2raya-x86_64-linux-sha256.txt"
